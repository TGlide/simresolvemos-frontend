    ...
    <div>
        ...
        <div className="px-4" style={{ maxWidth: "80%" }}>
          <Slider {...reviewsSliderSettings}>
            <div className="font-bold text-2xl">
              Me deram uma ajuda muito boa no meu trabalho de matemática, gostei
              muito do serviço.
            </div>
            <div className="font-bold text-2xl">
              Me ajudou muito a entender minha lista de cálculo, estava com
              muitas dúvidas e o professor não tinha passado o gabarito passo a
              passo.
            </div>
          </Slider>
        </div>
      ...
      <div className="flex flex-col lg:flex-row items-center mt-16 mb-16">
        <div className="px-2 text-center lg:text-right lg:ml-4 ">
          ...
          <p className=" text-sm lg:text-lg">
            A SimResolvemos busca auxiliar os alunos em seus estudos por meio de
            resoluções e vídeos explicativos,trazendo praticidade à todos.
            Conosco você tem acesso à profissionais que oferecem recursos e
            suporte para que você possa obter sucesso em sua jornada acadêmica.
            Nossa equipe é formada por professores/monitores de alta
            qualidade,com pleno conhecimento dos métodos de cada
            faculdade/escola e suas particularidades.
          </p>
        </div>
