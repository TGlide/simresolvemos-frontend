      ...
      <div className="h-full">
        <div>
          ...
          <p className="max-w-3xl mx-auto text-center text-sm opacity-75 mt-2">
            Na SimResolvemos você pode trabalhar de maneira autônoma e online.
            Quer fazer parte de nossa equipe? O processo é simples: preencha o
            formulário abaixo e se cadastre gratuitamente. Acesse os depoimentos
            em “Sobre nós” para saber mais sobre a experiência dos nossos
